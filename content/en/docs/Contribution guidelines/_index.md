...
1. Fork the [Goldydocs repo](https://github.com/hnccbits/learn.hnccbits.com) on GitHub.
...
1. Fork the [Goldydocs repo](https://github.com/hnccbits/learn.hnccbits.com) repo into your own project, then create a local copy using `git clone`. Don’t forget to use `--recurse-submodules` or you won’t pull down some of the code you need to generate a working site.
